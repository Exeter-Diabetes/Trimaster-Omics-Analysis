...
plot_forest(SGLT2_DPP4_lm, 
            ...
            save_path = "Plots/SGLT2_v_DPP4_differential_response_unadjusted.png",
            width = 10, height = 5.5)


# Checking PCs identified ----
# PC 5 and PC 7  identified
pc_identified <- NULL
...
for (pc in names(summary_sglt2_dpp4)) {
  write.csv(summary_sglt2_dpp4[[pc]],
            file = paste0("Output/summary_table_SGLT2_v_DPP4_unadjusted", pc, ".csv"),
            row.names = FALSE)
}
